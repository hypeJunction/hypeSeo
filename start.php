...
elgg_register_event_handler('init', 'system', function () {
    ...
    elgg_register_route('seo', ['path' => '/seo/{segments}', 'resource' => 'seo', 'requirements' => ['segments' => '.+'], 'defaults' => ['segments' => '']]);
    ...
    elgg_register_menu_item('page', array('name' => 'seo:settings', 'href' => 'admin/plugin_settings/hypeSeo', 'text' => elgg_echo('admin:seo:settings'), 'context' => 'admin', 'section' => 'seo'));
    elgg_register_menu_item('page', array('name' => 'seo:generator', 'href' => 'admin/seo/generator', 'text' => elgg_echo('admin:seo:generator'), 'context' => 'admin', 'section' => 'seo'));
    elgg_register_menu_item('page', array('name' => 'seo:rules', 'href' => 'admin/seo/rules', 'text' => elgg_echo('admin:seo:rules'), 'context' => 'admin', 'section' => 'seo'));
    elgg_register_menu_item('page', array('name' => 'seo:sitemap', 'href' => 'admin/seo/sitemap', 'text' => elgg_echo('admin:seo:sitemap'), 'context' => 'admin', 'section' => 'seo'));
});
